...
import { deleteReport } from '../service/report.service';
import Loading from './Loading';

export default function DeleteReportPopup({ onClose, record }) {
  ...
  const handleDelete = async () => {
    setLoading(true)
    try{
      await deleteReport(token, record.reportId)
    onClose()
    }
    catch (error) {
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5">
              <div className="flex gap-3">
                <Image src={Delete}/>
                <div>
                  <span className="font-semibold text-sm">Delete Report Issue</span>
